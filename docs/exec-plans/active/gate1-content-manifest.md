...
- ADR 013 `docs/architecture/013-versioned-content-manifests.md` — exact manifest identity, closed schema, compatibility, local authority, path safety, lifecycle integration requirement, and future migration boundary introduced by this work.
...
- 2026-09-23 — Manifest schema v1 is closed at every currently nested manifest-owned JSON object: unknown fields fail parsing rather than being ignored, preventing typos from silently erasing defaulted constraints.

...
<fieldset {disabled}><legend>Unarmed strike · damage</legend>
  <p>Use one Attack action attack to punch, kick or headbutt a creature within 5 feet. Roll Strength plus proficiency to hit; damage is 1 plus Strength, with no damage die. You can kick with both hands occupied.</p>

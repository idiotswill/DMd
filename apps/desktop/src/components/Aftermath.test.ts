...
function tactical():TacticalView {
  return {encounter_id:'encounter',phase:'active',execution:'ReactionsV1',round:1,active_actor:'pc',battlefield:null,participants:[],combatant_sources:[],observers:[],initiative:[],ties:[],continuation:null,may_fail_save:null,legendary_resistance:null,legendary_action:null,budget:null};
}
